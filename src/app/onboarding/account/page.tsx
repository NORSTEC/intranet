...
const linkErrors: Record<string, string> = {
  ...
  profile_has_data: "The other profile already contains portal data and must be merged by Norstec IT.",
...
export default async function AccountOnboardingPage({
  ...
  return (
    <PortalEntryShell>
      <section>
        <h1 className="text-h2">Do you already have a portal profile?</h1>
        ...
        <div className="mt-8 grid max-w-4xl gap-5 md:grid-cols-2">
          ...
          <article className="portal-surface flex min-h-64 flex-col p-6 sm:p-7">
            ...
            <form action={createNewPortalProfile} className="mt-7">
              <button className="portal-button" type="submit">Create profile</button>
            </form>
          </article>
        </div>
      </section>
